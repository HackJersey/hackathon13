...
<html lang="en">
  ...
  <div class="container">
  	  <form class="form-signin" method="post" action="#">
         <h2 class="form-signin-heading">Zip-Code?</h2>
         <span class="muted">Please Enter Your Zip-Code</span>
         ...
         <!--<select name= "state" class="select">
           ...
           <?php 
           	for ($i = 1; $i <= 52; $i++) {		
           ?>
           <option value="<?php echo $i;?>"><?php echo "db-value : ".$i;?></option>
          <?php 
          } 
          ?>
         </select>-->
         
                  <input type="text" name="zipcode" id="zipCode" class="zipCode" value=""/>
         </br>
...
<?php //} ?>	
      <!-- /END THE FEATURETTES -->
           ...
           <h2 class="featurette-heading"><?php echo "Do you want to act now?";?>
      </br>
       <span class="muted">Where do you stand?</span>
      </h2>
    <?
    $pro = "Make strict laws!";
    $anti ="No more rules save the 2nd Amendment";
    ...
    ?>
      ...
      <a href="https://twitter.com/intent/tweet?screen_name=<?php echo $TWITTER ?>&text=<?php echo $pro;?>" class="twitter-mention-button" data-size="large">Tweet to <?php echo $TWITTER; ?></a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
      </div>
      <div class="span4">
      <img class="img-circle" data-src="holder.js/240x240"/>
      <h2>Support gun rights</h2>
      <a href="https://twitter.com/intent/tweet?screen_name=<?php echo $TWITTER; ?>&text=<?php echo $anti; ?>" class="twitter-mention-button" data-size="large">Tweet to <?php echo $TWITTER; ?></a>
      <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
      </div>
